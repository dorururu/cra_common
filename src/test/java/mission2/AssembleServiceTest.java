...
import static mission2.AssembleProcess.CarType_Question;
import static mission2.AssembleProcess.Engine_Question;
...
class AssembleServiceTest {
    ...
    void engine_carType_input_should_be_1_4_fail(String userInput) {
        AssembleService assembleService = new AssembleService();
